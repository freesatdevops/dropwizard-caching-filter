...
public class HttpResponseTest {
  ...
  public void testFrom() {
    ...
    final Response.ResponseBuilder builder =
        Response.status(expectedHttpCode).entity(expectedEntity);
    ...
    final ContainerResponseContext mockContainerResponseContext =
    ...
    String expectedResponseJson = objectMapper.valueToTree(expectedResponse).toString();
    String actualResponseJson = objectMapper.valueToTree(actualResponse).toString();
    assertThat(actualResponseJson).isEqualToIgnoringCase(expectedResponseJson);
  }
}
